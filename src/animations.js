...
class Animation {
  ...
  play(animationName, isIntersecting) {
    ...
    const animationFrames = keyframes.filter(
      (o) =>
        o.animationFor === animationName &&
        o.isEntryAnimation === isIntersecting
    );

    const anim = this.element.animate(animationFrames[0].frames, {
